...
import type { CliInstalledPlugin } from './cliTypes';
...
export interface AddonsCatalog {
  ...
  /** CLI-installed plugins (empty when CLI is unavailable). */
  readonly cliInstalledPlugins: readonly CliInstalledPlugin[];
