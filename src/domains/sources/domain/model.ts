 ...
 * Codex: .codex/config.toml (project or user home: akashi.sources.homePathOverrides.codex → CODEX_HOME → ~/.codex), AGENTS.override.md (any dir), .codex/rules/*.rules; not indexed: auth.json, history, logs/sessions.
